...
public class SuccessPopUp extends JWindow {

    private float opacity = 0f;

    public SuccessPopUp(Frame parent, String title, String message) {
        super(parent);
        ...
        JPanel panel = new JPanel() {
            ...
            protected void paintComponent(Graphics g) {
                ...
                g2.setColor(GlobalView.CONFIRM_BUTTON_BACKGROUND);
        ...
        ImageIcon icon = loadIcon(p.getProperties("success-icon"), 48, 48);
    ...
    public static void showSuccessPopup(Frame parent, String title, String message) {
        new SuccessPopUp(parent, title, message);
    }
