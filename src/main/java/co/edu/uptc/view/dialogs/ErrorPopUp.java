...
public class ErrorPopUp extends JWindow {

    private float opacity = 0f;

    public ErrorPopUp(Frame parent, String title, String message) {
        super(parent);
        ...
        JPanel panel = new JPanel() {
            ...
            protected void paintComponent(Graphics g) {
                ...
                g2.setColor(GlobalView.CANCEL_BUTTON_BACKGROUND);
        ...
        ImageIcon icon = loadIcon(p.getProperties("error-icon"), 48, 48);
    ...
    public static void showErrorPopup(Frame parent, String title, String message) {
        new ErrorPopUp(parent, title, message);
    }
