...
public class ViewSalesDetailsPanel extends JPanel {
    ...
    private JSONObject saleData;
    private List<Product> productCatalog;
    private final DecimalFormat currencyFormatter;

    public ViewSalesDetailsPanel(JPanel parentPanel, ViewController controller,
            Presenter presenter, JSONObject saleData) {
    ...
    private void initComponents() {
        ...
        add(createTitle("Detalles del Registro de Venta"), BorderLayout.NORTH);
    ...
    private JPanel createMasterInfoPanel() {
        ...
        gbc.gridy = 0;
        gbc.weightx = 0.9;
        formPanel.add(createValueLabel(saleData.optString("invoiceNumber")), gbc);
        ...
        gbc.gridx = 1;
        gbc.gridy = 1;
        formPanel.add(createValueLabel(saleData.optString("customerName")), gbc);
        ...
        gbc.gridx = 1;
        gbc.gridy = 2;
        formPanel.add(createValueLabel(saleData.optString("date")), gbc);
        ...
        gbc.gridx = 1;
        gbc.gridy = 3;
        formPanel.add(createValueLabel(saleData.optString("status")), gbc);
        ...
        lblTotalValue = new JLabel(formatCurrency(saleData.optLong("total")));
    ...
    private JPanel createItemsDetailPanel() {
        ...
        String[] itemColumns = { "ID Producto", "Nombre", "Cantidad", "Precio Unitario", "Subtotal" };
